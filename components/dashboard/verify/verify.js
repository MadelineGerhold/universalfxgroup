...
export default function Verify() {
  ...
  const [frontIDSecureUrl, setFrontIDSecureUrl] = useState(null);
  const [backIDSecureUrl, setBackIDSecureUrl] = useState(null);
      ...
      <div className="p-4">
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
          ...
          <p className="text-green-700 mb-4">
            Your verification has been approved. You can now access all platform
            features.
          </p>
          <Button
      ...
      <div className="p-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
          ...
          <p className="text-blue-700 mb-4">
            Your documents have been submitted successfully. We are reviewing your
            verification request and will update you once complete.
          </p>
          <Button
            onClick={() => router.push("/dashboard")}
      ...
      >
        ...
        {idType && (
          <form onSubmit={handleSubmit} className="">
            ...
            <button
              type="submit"
              className="w-full px-4 mt-4 flex justify-center items-center text-sm rounded bg-[#02B0F6] my-3 text-white font-bold  focus:outline-none "
            >
              {loading ? (
