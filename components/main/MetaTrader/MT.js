        ...
        <section className="text_section md:px-8 px-2 pt-7">
          <div className="textcontaier">
            <div
              ...
              data-aos-delay="100"
            >
              Advanced <span className="text-[#02B0F6]">AI Crypto Trading</span>{" "}
              <br /> Platforms &{" "}
              <span className="text-[#02B0F6]">Financial Technology</span>
            </div>
            <div
              ...
              >
                <div className="icon">
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="w-6 h-6 mr-2 text-[#02B0F6] mt-0.5"
                  >
                    <path
                      fillRule="evenodd"
              ...
              >
                <div className="icon">
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="w-6 h-6 mr-2 text-[#02B0F6]"
                  >
                    <path
                      fillRule="evenodd"
                      d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z"
